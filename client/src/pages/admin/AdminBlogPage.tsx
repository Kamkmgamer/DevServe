// client/src/pages/admin/AdminBlogPage.tsx
...
type BlogPost = {
  ...
  title: string;
  summary: string;
  category: string; // Assuming category for consistency
  createdAt: string;
};
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
              Search, filter, sort and manage your blog content.
            </p>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button as={Link} to="/admin/blog/new" variant="primary">
              Add Post
            </Button>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 shadow-sm dark:border-gray-700">
          ...
          {!loading && !error && sorted.length === 0 && (
            <div className="p-10 text-center text-sm text-gray-600 dark:text-gray-400">
              No posts found. Try adjusting filters or add a new one.
            </div>
          )}
